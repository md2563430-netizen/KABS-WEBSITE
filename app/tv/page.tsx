...
export default function TVPage() {
  ...
  const channels: TVChannel[] = [
    // Uganda (examples)
    {
      ...
      featured: true,
      live: true,
      logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR7wX0uzOjFxeRgrXma7ILe5z8soYZUaLhiBg&s',
      videoType: 'youtube',
    ...
    },
     {
      ...
      featured: true,
      live: true,
      logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKw8BcoJsQ_4ODHuGrH5J4q4uBBw0m0JDpuA&s',
      videoType: 'youtube',
      videoUrl: 'https://stream.hydeinnovations.com/bukedde2flussonic/tracks-v2a1/mono.m3u8',
    ...
    },
    {
      ...
      featured: true,
      live: true,
      logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRi1-sXcqmzOD9ZNqj261aOZ7DtOYMsoaneyw&s',
      videoType: 'youtube',
      videoUrl: 'https://stream.hydeinnovations.com/tvwest-flussonic/tracks-v1a1/mono.m3u8',
      description: 'Live news and updates.',
    },
    {
      id: 'BTV',
      ...
      videoType: 'youtube',
      videoUrl: 'https://streamfi-alphadgtl1.zettawiseroutes.com:8181/hls/stream_src.m3u8',
      description: 'Live and prayer sessions.',
    },
    {
      id: 'Galaxy TV',
      name: 'Galaxy TV',
      ...
      featured: true,
      live: true,
      logo: 'https://mytv256.com/upload/galaxy%20tv.jpg',
      videoType: 'youtube',
